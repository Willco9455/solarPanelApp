...
@ReactModule(name = BearingModule.NAME)
public class BearingModule extends ReactContextBaseJavaModule implements SensorEventListener  {


    public static final String NAME = "BearingModule";
    ...
    public BearingModule(ReactApplicationContext reactContext) {
        super(reactContext);
